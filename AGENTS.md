...
- Project import: `.aup3`/`.aup4`/`.aup3unsaved` render natively (SQLite + binary-XML + sampleblocks; clean-room, format-referenced only); fixtures via `tests/fixtures/make_aup3.py`, harness `test_audacity.cpp` (16 checks, /W3 clean).
