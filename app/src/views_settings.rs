...
use gpui_kit::{div, rgb, App, Context, Entity, FontWeight, IntoElement, Render, Subscription, Window};
...
fn section(title: &str, dark: bool) -> impl IntoElement {
    div()
...
impl Render for SettingsView {
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        .to_string();
        let theme_id = if dark { "dark" } else { "light" }.to_string();
        ...
        body = body
            .child(section("Appearance", dark))
            .child(choice(
                "theme",
                &[("dark", "Dark", theme_id == "dark"), ("light", "Light", theme_id == "light")],
                store.clone(),
            ))
            .child(choice(
                "density",
        ...
        body = body
            .child(section("Run defaults (Start uses these)", dark))
            .child(div().child(format!("Default classes: {classes_cur}")).font_weight(FontWeight::SEMIBOLD))
            .child(
                h_flex()
                    .gap_2()
                    .child(div().flex_1().child(Input::new(&classes_e)))
                    .child(
            ...
            .child(div().child("Start transcribes + summarizes with these; no per-run boxes.").font_weight(FontWeight::SEMIBOLD));
        body = body
            .child(section("Processing", dark))
            .child(choice(
                "compute",
                &[
            ...
            .child(div().child(adv).font_weight(FontWeight::SEMIBOLD))
            .child(choice(
                "denoise",
                &[
            ...
            .child(
                div()
                    .child("Adaptive room-tone gate on the STT copy only — archival takes stay untouched. If voices clip and mic effects are already on outside the app, try Off.")
                    .font_weight(FontWeight::SEMIBOLD),
            )
            .child(
                h_flex()
        ...
        body = body
            .child(section("Summary (length tier drives chunks + guide + ratio)", dark))
            .child(choice(
                "sumtier",
                &[
            ...
            .child(div().child(chunk_line).font_weight(FontWeight::SEMIBOLD))
            .child(
                div()
                    .child(
        ...
        body = body
            .child(section("Storage", dark))
            .child(div().child(format!("Output folder: {outdir_cur}")).font_weight(FontWeight::SEMIBOLD))
            .child(
                h_flex()
                    .gap_2()
                    .flex_wrap()
            ...
            .child(
                div()
                    .child("Delete/archive apply to successful outputs only — failures, aborts, and videos are never touched.")
                    .font_weight(FontWeight::SEMIBOLD),
            )
            .child(div().child(format!("Review drafts: {reviews_cur}")).font_weight(FontWeight::SEMIBOLD))
            .child(
                h_flex()
                    .gap_2()
                    .flex_wrap()
        ...
        body = body
            .child(section("Documents", dark))
            .child(div().child(doc).font_weight(FontWeight::SEMIBOLD))
            .child(
                h_flex()
                    .gap_2()
                    .child(div().flex_1().child(Input::new(&docmax_e)))
                    .child(
        ...
        body = body
            .child(section("Merging", dark))
            .child(div().child(merge).font_weight(FontWeight::SEMIBOLD))
            .child(
                h_flex()
                    .gap_2()
                    .child(div().flex_1().child(Input::new(&suggest_e)))
                    .child(div().flex_1().child(Input::new(&prompt_e)))
                    .child(
        ...
        body = body
            .child(section("Documentary (video attention)", dark))
            .child(
                div()
                    .child(format!(
            ...
            .child(
                div()
                    .child(format!("{vlm_line} (change on the Models page → Vision)"))
                    .font_weight(FontWeight::SEMIBOLD),
            );
        body = body
            .child(section("Research (web, opt-in)", dark))
            .child(choice(
                "websrch",
            ...
            .child(
                div()
                    .child("Off by default. When on, video jobs may fetch pages AFTER watching — web text is cited per-claim and never mixed with film facts.")
                    .font_weight(FontWeight::SEMIBOLD),
            );
        body = body
            .child(section("Diagnostics", dark))
            .child(
                h_flex()
                    .gap_2()
                    .flex_wrap()
